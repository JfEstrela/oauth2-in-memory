package br.com.oauth2.in.memory.service;
...
import br.com.oauth2.in.memory.repository.ClientDetailsRepository;
...
public class UserDetailsServiceImpl implements UserDetailsService {
    ...
    private void createUserAdm() {
    	User user = new User();
    	user.setUsername("oauth2-in-memory");
    	user.setPassword(passwordEncoder.encode("yromem-ni-2htuao"));
